...
const ProductCard = ({
  ...
  const handleAddToCart = () => {
    if (selectedQuantity > 0) {
      ...
      Alert.alert(
        "Erreur",
        "La quantit\u00E9 doit être supérieure à z\u00E9ro pour ajouter au panier."
      );
    }
  };
    ...
    <View style={styles.card}>
      ...
      <View style={styles.quantityContainer}>
        <TouchableOpacity
          ...
          onPress={() =>
            handleQuantityChange(Math.max(0, selectedQuantity - 1))
          }
        >
      ...
      >
        <Text style={styles.textAddBuy}>
          {cartQuantity > 0 ? "Mettre à jour le panier" : "Ajouter au panier"}
        </Text>
      </TouchableOpacity>
    </View>
  );
